  ...
  return (
    ...
    >
      <div className='listingheader-wrapper'>
        ...
        >
          ...
          {isCompany ? (
            <>
              <div
                id='w-node-_5f9bbd68-5925-7f41-4e08-47c4097194db-5d4911ed'
                class='compcontainer'
              >
                <div class='logo-wrapper'>
                  <img
                    src='https://uploads-ssl.webflow.com/6223552248fd5d64304911ec/622788b6ed5b1301d589b856_ASAN.svg'
                    loading='lazy'
                    alt=''
                  />
                </div>
      ...
      <div className='div-block-4'>
        <h4
          id='w-node-_5f9bbd68-5925-7f41-4e08-47c4097194e4-5d4911ed'
          className='iscolumn black50'
        >
          {ARR ? ARR : "-"}
        </h4>
        <h4
          id='w-node-_5f9bbd68-5925-7f41-4e08-47c4097194e6-5d4911ed'
          className='iscolumn black50'
        >
          {CCR ? CCR : "-"}
        </h4>
...
const Table = (props) => {
  ...
  return (
    <div
      id='w-node-_436487ff-0a8b-05ed-b67d-aafecf95f379-5d4911ed'
      className='metrics widthfull'
    >
      <div
        id='w-node-_2c6e5316-4ef7-fb3c-7fc6-16076e37e42b-5d4911ed'
        className='separator'
      ></div>
      ...
      <div class='metric-entry istable'>
        ...
        <div class='div-block-4'>
          <h4
            id='w-node-_436487ff-0a8b-05ed-b67d-aafecf95f37e-5d4911ed'
            class='iscolumn'
          >
            ARR
          </h4>
          <h4
            id='w-node-_436487ff-0a8b-05ed-b67d-aafecf95f380-5d4911ed'
            class='iscolumn'
          >
            CCR
          </h4>
          <h4
            id='w-node-_06af9ce0-e762-bd28-f8f4-da23828e9c33-5d4911ed'
            class='iscolumn'
          >
            LTV
          </h4>
          <h4
            id='w-node-cb07bc53-cdcb-0899-354b-99a0f44924bb-5d4911ed'
            class='iscolumn'
          >
            CAC
          </h4>
          <h4
            id='w-node-_0a377e6d-9df9-25b2-2352-cfe26081a062-5d4911ed'
            class='iscolumn isaction'
          >
            Actions
          </h4>
        </div>
      ...
      {data.map((filing, i) => {
        return <Row_custom filing={filing} />;
      })}
    </div>
  );
};
