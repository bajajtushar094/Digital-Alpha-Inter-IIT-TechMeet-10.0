# -*- coding: utf-8 -*-
"""extracting_annual_data_from_outside_src.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1s46S4bJK2Ye0TtkUlUmjSPHxQJPS9Q6b
"""
...
for metric in mets:
    ...
    df[str(metric)] = vals
    df['filenames'] = filenames
    csvname = 'data_for_dev_team/annual/' + str(metric) + '.csv'
    df.to_csv(csvname)

directory = "quarter_button_bs"
...
# C:\Users\gitan\OneDrive\Desktop\interiit\notebooks\extractfromyahoo_annual.ipynb
# mets = ['Selling General and Administrative','Operating Income'
# ,'Selling & Marketing Expense']
...
directory = "quarter_button_cf"


mets = ['Operating Cash Flow',
'Investing Cash Flow',
'Financing Cash Flow',
'End Cash Position',
...
for metric in mets:
    ...
    df[str(metric)] = vals
    df['filenames'] = filenames
    csvname = 'data_for_dev_team/annual/bs/' + str(metric) + '.csv'
    df.to_csv(csvname)