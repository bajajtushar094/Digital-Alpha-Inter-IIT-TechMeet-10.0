# -*- coding: utf-8 -*-
"""buttonclickscrape.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1IEZHAJ3eoW_PJa_1I_OdTiuyznvkmNtI
"""
...
for ticker in tickers_list:
    ...
    for link in [is_link,bs_link,cf_link]:
        driver.get(link)
        time.sleep(5)
        button1 = driver.find_element_by_xpath('//*[@id="Col1-1-Financials-Proxy"]/section/div[1]/div[2]/button/div/span')
        button1.click()
        time.sleep(5)
        button2 = driver.find_element_by_xpath('//*[@id="Col1-1-Financials-Proxy"]/section/div[2]/button/div/span')
        button2.click()
        time.sleep(5)
