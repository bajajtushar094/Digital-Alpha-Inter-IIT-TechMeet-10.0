...
rootPath = 'C:\\Users\\Aman\\Documents\\GitHub\\Digital-Alpha-Inter-IIT-TechMeet-10.0\\backend\\csv_data\\'

fileCIK = open(rootPath + 'cik_with_ticker.csv')
...
fileLogo = open(rootPath + 'tickerToImage.csv')
